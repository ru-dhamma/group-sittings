...
<div class="grid grid-cols-12 gap-2">
  ...
  <div class="col-span-10">
    ...
    <div class=""><Link type="map" url={address.map}>Картра</Link></div>
...
<div class="grid grid-cols-12 gap-2">
  ...
  <div class="col-span-10">
    {#if contact.phone}<div class=""><Link type="tel" url={contact.phone} messangers={contact.messangers}>{formatPhoneNumber(contact.phone)}</Link></div>{/if}
